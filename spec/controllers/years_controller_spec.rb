...
#       expect(assigns(:years)).to eq([year])
#     end
#   end
...
#         post :create, {:year => valid_attributes}, valid_session
#         expect(assigns(:year)).to be_a(Year)
#         expect(assigns(:year)).to be_persisted
#       end
...
#         post :create, {:year => invalid_attributes}, valid_session
#         expect(assigns(:year)).to be_a_new(Year)
#       end
...
#         year = Year.create! valid_attributes
#         put :update, {:id => year.to_param, :year => new_attributes}, valid_session
#         year.reload
...
#         year = Year.create! valid_attributes
#         put :update, {:id => year.to_param, :year => invalid_attributes}, valid_session
#         expect(assigns(:year)).to eq(year)
#       end
